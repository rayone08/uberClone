    ...
    <View style = {styles.container}>
        ...
        <ScrollView bounces={false}> 
          <View style={styles.home}>
            <Text style = {styles.text1} >Hi Bachu!</Text>
          ...
          <View>
            ...
            <View style={styles.viewN3}>
              <Text style={styles.text3}>Whter to?</Text>
            ...
            <View style={{...styles.view5}}>
              <View style={styles.view6}>
                ...
                <View>
                <Text style={{fontSize:18,color:colors.black}}>47 Amarasingam Rd</Text>
                <Text style={{color:colors.grey3}}>Arayamapthy, Batticaloa</Text>
                </View>
              </View>
              <View>
              <Icon 
              ...
              <View style={styles.view6}>
                ...
                <View>
                <Text style={{fontSize:18,color:colors.black}}>05 Old Rd</Text>
                <Text style={{color:colors.grey3}}>Arayamapthy, Batticaloa</Text>
                </View>
              </View>
              <View>
